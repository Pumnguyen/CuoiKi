...
public class Users implements Serializable{
	...
	@Column(name = "UserFullName", columnDefinition = "VARCHAR(200) NOT NULL")
	...
	@Column(name = "UserAddress", columnDefinition = "VARCHAR(200) NOT NULL")
	private String useraddress;
	
	@Column(name = "UserName", columnDefinition = "VARCHAR(100) NOT NULL")
	private String userName;
	
	@Column(name = "UserPassword", columnDefinition = "VARCHAR(400) NOT NULL")
